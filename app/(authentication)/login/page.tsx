      ...
      <main className="min-h-screen w-full flex items-center justify-center">
        <div className="flex flex-col min-w-full md:flex-row w-full min-h-screen justify-center items-center mx-auto">
          <Image
            ...
            alt="Sign in svg"
          />
          <div className="h-auto flex-1 min-w-[320px] md:w-[370px] md:flex-none px-4 py-6 border rounded-lg shadow-sm">
            <h1 className="text-[27px] leading-relaxed font-medium text-gray-800 ">
               Welcome to <span className="text-primaryColor font-bold">ReThink</span>     
            </h1>
            <p className="font-normal text-md text-gray-500">Sign in your account</p>
            <CredentialForm />
